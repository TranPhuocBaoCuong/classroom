...
<?php
	...
	&& isset($_POST['birthday']) && isset($_POST['phone']))
    {
        ...
        if (empty($first_name)) {
            ...
            $result = register($first_name, $last_name, $birthday, $phone, $email, $user, $pass);
            if ($result['code'] == 0){
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 border my-5 p-4 rounded mx-3">
                ...
                <form method="post" action="" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= $birthday?>" name="birthday" required class="form-control" type="text" placeholder="Birthday" id="birthday">
                    </div>
                    <div class="form-group">
